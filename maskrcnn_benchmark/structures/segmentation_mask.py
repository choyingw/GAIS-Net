...
class PolygonList(object):
    ...
    def __getitem__(self, item):
        ...
        if isinstance(item, int):
            ...
            #print("**The polygon l:", len(self.polygons))
            ...
            for i in item:
                #print("The i is:",i)
                #print("The polygon length:", len(self.polygons))
                #if i >= len(self.polygons):
                #    print("break out!!!")
                #    break
                #print(self.polygons)
                selected_polygons.append(self.polygons[int(i)])
                # try:
                #     selected_polygons.append(self.polygons[int(i)])
                # except IndexError:
                #     print("Catch err")
