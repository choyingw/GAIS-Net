...
_C.INPUT.MULTI_REPR = False 
# With disparity map input
_C.INPUT.WITHDISP = False
# If using PointNet Pretrain
_C.INPUT.PRETRAIN = False
# If using z1 data
_C.INPUT.Train_Z1 = False
_C.INPUT.Test_Z1 = False
